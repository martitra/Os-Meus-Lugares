...
public class RecursoIcono {
	...
	/**
	 * metodo para coger el icono en drawable 
	 * getResources es para coger lo que está en la carpeta res
	...
	public Drawable obtenDrawableIcon(String icon){
		...
		//return iconosLugares.getDrawable(0);//cero para probar/ esto devuelve un drabwsble
	}
}
